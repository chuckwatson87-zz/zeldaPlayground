...
define('app.test',['./app'], function (_app) {
  'use strict';

  describe('the app', function () {
    it('says hello', function () {
      expect(new _app.App().message).toBe('Hello World!');
    });
  });
});
...
define('engine/components/compnonents',["exports"], function (exports) {
  "use strict";
...
define('game/world/player/player',['exports', './sprites'], function (exports, _sprites) {
  'use strict';
  ...
  var player = function () {
    ...
    player.prototype.addSprite = function addSprite(canvas) {
      ...
      console.log(_sprites.spriteAtlas);

      link.onload = function () {
        var linkSprite = _this.sprite({
          context: canvas.getContext("2d"),
          atlas: _sprites.spriteAtlas,
          image: link
        });
    ...
    player.prototype.sprite = function sprite(options) {
      ...
      s.render = function (frameName) {
        var frame = s.atlas.frames[frameName].frame;
