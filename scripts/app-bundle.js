...
define('engine/engine',["exports"], function (exports) {
  "use strict";
...
define('engine/components/sprite',["exports"], function (exports) {
  "use strict";
  ...
  var sprite = {
    create: function create(canvas, imagePath, atlas) {
      var s = {
...
define('game/world/world',['exports', './player/player'], function (exports, _player) {
  ...
  var world = exports.world = function () {
    ...
    world.prototype.attached = function attached() {
      var p = new _player2.default(this.mainWorld);
      p.init();
    };
...
define('game/world/player/player',['exports', './sprites', 'engine/components/sprite'], function (exports, _sprites, _sprite) {
  'use strict';
  ...
  var player = function () {
    ...
    player.prototype.init = function init() {
      var spritePath = 'scripts/resources/sprites/link/sprites.png';
      var player = _sprite2.default.create(this.canvas, spritePath, _sprites.spriteAtlas);
      player.loadSprite(true, 25, 25, 'link_01');
    };
